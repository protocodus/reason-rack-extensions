...
front = {
	S_backdrop = { { path = "Reason_GUI_front_root_Panel" } },
	{
		...
		S_status_quality = widget(84, 48, "EngineDisplay", 1),
		S_status_vcfTanhMode = widget(183, 48, "EngineDisplay", 1),
		S_status_vcfFastEarlyMode = widget(286, 48, "EngineDisplay", 1),
		S_status_vcfSolverMode = widget(395, 48, "EngineDisplay", 1),
		S_status_calibration = widget(524, 48, "EngineDisplay", 1),
		S_status_aging = widget(627, 48, "EngineDisplay", 1),
