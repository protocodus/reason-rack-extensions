...
front = {
	S_backdrop = { { path = "Reason_GUI_front_root_Panel" } },
	{
		...
		S_note_on = lamp(724, 52),
		S_status_quality = widget(70, 49, "EngineDisplay", 1),
		S_status_vcfTanhMode = widget(171, 49, "EngineDisplay", 1),
		S_status_vcfFastEarlyMode = widget(276, 49, "EngineDisplay", 1),
		S_status_vcfSolverMode = widget(388, 49, "EngineDisplay", 1),
		S_status_calibration = widget(520, 49, "EngineDisplay", 1),
		S_status_aging = widget(624, 49, "EngineDisplay", 1),

		-- Row 1: LFO, oscillator, high-pass filter
		S_fader_lfoRate = fader(31, 126, "FaderSource"),
		S_fader_lfoDelay = fader(98, 126, "FaderSource"),
		S_fader_range = fader(183, 126, "FaderSource"),
		S_fader_dcoLfo = fader(248, 126, "FaderSource"),
		S_fader_pwm = fader(307, 126, "FaderSource"),
		S_fader_pwmMode = fader(387, 126, "FaderSource"),
		S_toggle_pulse = toggle(463, 134),
		S_toggle_saw = toggle(463, 166),
		S_fader_sub = fader(555, 126, "FaderSource"),
		S_fader_noise = fader(618, 126, "FaderSource"),
		S_fader_highPass = fader(707, 126, "FaderSource"),

		-- Row 2: filter, amplifier, envelope, chorus
		S_fader_cutoff = fader(29, 280, "FaderShape"),
		S_fader_resonance = fader(74, 280, "FaderShape"),
		S_fader_envPolarity = fader(121, 280, "FaderShape"),
		S_fader_vcfEnv = fader(163, 280, "FaderShape"),
		S_fader_vcfLfo = fader(204, 280, "FaderShape"),
		S_fader_keyFollow = fader(249, 280, "FaderShape"),
		S_fader_vcaMode = fader(338, 280, "FaderShape"),
		S_fader_vcaLevel = fader(391, 280, "FaderShape"),
		S_fader_attack = fader(457, 280, "FaderShape"),
		S_fader_decay = fader(496, 280, "FaderShape"),
		S_fader_sustain = fader(534, 280, "FaderShape"),
		S_fader_release = fader(573, 280, "FaderShape"),
		S_fader_chorus = fader(649, 280, "FaderEffect"),
		S_fader_chorusNoise = fader(702, 280, "FaderEffect"),

		-- Row 3: performance and keyboard
		S_pitch_wheel = wheel(30, 433, "PitchWheel"),
		S_mod_wheel = wheel(82, 433, "ModWheel"),
...
back = {
	S_backdrop = { { path = "Reason_GUI_back_root_Panel" } },
	{
		...
		S_radio_quality_0 = toggle(80, 146),
		S_radio_quality_1 = toggle(80, 177),
		S_radio_quality_2 = toggle(80, 208),
		S_radio_vcfTanhMode_0 = toggle(188, 146),
		S_radio_vcfTanhMode_1 = toggle(188, 177),
		S_radio_vcfTanhMode_2 = toggle(188, 208),
		S_radio_vcfFastEarlyMode_0 = toggle(296, 161),
		S_radio_vcfFastEarlyMode_1 = toggle(296, 192),
		S_radio_vcfSolverMode_0 = toggle(404, 146),
		S_radio_vcfSolverMode_1 = toggle(404, 177),
		S_radio_vcfSolverMode_2 = toggle(404, 208),
		S_fader_calibration = fader(544, 146, "FaderPlay"),
		S_fader_aging = fader(636, 146, "FaderPlay"),
		S_cv_input_note = widget(95, 387, "CVJack", 3),
		S_cv_input_gate = widget(167, 387, "CVJack", 3),
		S_cv_input_cutoff = widget(239, 387, "CVJack", 3),
		S_cv_input_resonance = widget(311, 387, "CVJack", 3),
		S_cv_input_volume = widget(95, 477, "CVJack", 3),
