...
back = jbox.panel{
	...
	widgets = {
		...
		radio(80, 409, "quality", 1),
		radio(80, 440, "quality", 2),
		radio(188, 378, "vcfTanhMode", 0),
		radio(188, 409, "vcfTanhMode", 1),
		radio(188, 440, "vcfTanhMode", 2),
		radio(296, 393, "vcfFastEarlyMode", 0),
		radio(296, 424, "vcfFastEarlyMode", 1),
		radio(404, 378, "vcfSolverMode", 0),
		radio(404, 409, "vcfSolverMode", 1),
		radio(404, 440, "vcfSolverMode", 2),
		fader(544, 378, "calibration", "FaderPlay", true, true),
		fader(636, 378, "aging", "FaderPlay", true, true),
