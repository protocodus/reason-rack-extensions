...
front = jbox.panel{
	...
	widgets = {
		patch_name(284, 14, 16, "Arial medium font"),
		...
		status(70, 49, "quality"),
		status(171, 49, "vcfTanhMode"),
		status(276, 49, "vcfFastEarlyMode"),
		status(388, 49, "vcfSolverMode"),
		status(520, 49, "calibration"),
		status(624, 49, "aging"),

		-- Row 1: LFO, oscillator, high-pass filter
		fader(31, 126, "lfoRate", "FaderSource"),
		fader(98, 126, "lfoDelay", "FaderSource"),
		fader(183, 126, "range", "FaderSource"),
		fader(248, 126, "dcoLfo", "FaderSource"),
		fader(307, 126, "pwm", "FaderSource"),
		fader(387, 126, "pwmMode", "FaderSource"),
		toggle(463, 134, "pulse"),
		toggle(463, 166, "saw"),
		fader(555, 126, "sub", "FaderSource"),
		fader(618, 126, "noise", "FaderSource"),
		fader(707, 126, "highPass", "FaderSource"),

		-- Row 2: filter, amplifier, envelope, chorus
		fader(29, 280, "cutoff", "FaderShape"),
		fader(74, 280, "resonance", "FaderShape"),
		fader(121, 280, "envPolarity", "FaderShape"),
		fader(163, 280, "vcfEnv", "FaderShape"),
		fader(204, 280, "vcfLfo", "FaderShape"),
		fader(249, 280, "keyFollow", "FaderShape"),
		fader(338, 280, "vcaMode", "FaderShape"),
		fader(391, 280, "vcaLevel", "FaderShape"),
		fader(457, 280, "attack", "FaderShape"),
		fader(496, 280, "decay", "FaderShape"),
		fader(534, 280, "sustain", "FaderShape"),
		fader(573, 280, "release", "FaderShape"),
		fader(649, 280, "chorus", "FaderEffect"),
		fader(702, 280, "chorusNoise", "FaderEffect"),
