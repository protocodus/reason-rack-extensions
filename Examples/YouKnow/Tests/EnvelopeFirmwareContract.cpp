// Rack copy of the upstream envelope firmware suite (Tests/YouKnowEnvelopeFirmwareTests.cpp
// at 5d9390d): an independent B-2 branch oracle, exhaustive reachable
// note/HOLD/pass sequences, retained-decay witnesses and block-partition
// independence. Kept verbatim apart from the include path so the C++17
// port is held to the same firmware semantics as the source.
